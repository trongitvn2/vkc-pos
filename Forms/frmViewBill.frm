...
Begin VB.Form frmViewBill 
   Caption         =   "Preview Bill Old"
   ClientHeight    =   9120
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10335
...
'    End If
    If ArrayFlag(SF(0), 8) = 1 Then blnMenu_Out = True
