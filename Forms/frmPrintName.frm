...
Begin VB.Form frmPrintName 
   ...
   Begin VB.Frame frmCmd 
      ...
      Begin prjTouchScreen.MyButton cmdClose 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPrintName.frx":000C
         PICN            =   "frmPrintName.frx":0028
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdHelp 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPrintName.frx":62C2
         PICN            =   "frmPrintName.frx":62DE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmPrintName.frx":6918
         PICN            =   "frmPrintName.frx":6934
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin TabDlg.SSTab tab1 
      ...
      EndProperty
      TabCaption(0)   =   "Set up"
      TabPicture(0)   =   "frmPrintName.frx":6E78
   ...
   End
End
Attribute VB_Name = "frmPrintName"
...
On Error GoTo errHdl
    ...
    With Me
        ...
        .WindowState = 0
    End With
    Set res = Open_Table(cnData, "Friendly_Printers")
...
'    Call SetColorFlexGrid(flex, 1, 1, 2)
    With flex
        ...
        .ScrollTrack = True
    End With
    txtData.MaxLength = res.Fields("PrinterName").DefinedSize
    flex_Click
    ...
    With res
        If .RecordCount > 0 Then
            ...
            Do While Not .EOF
                ...
                flex.TextMatrix(irow, 0) = !PrtID
                flex.TextMatrix(irow, 1) = !PrinterName
                irow = irow + 1
                .MoveNext
            Loop
        End If
...
On Error GoTo errHdl
    ...
    With flex
        ...
        .ColWidth(0) = 390: .ColAlignment(0) = 4
...
On Error GoTo errHdl
    ...
    txtData.Text = ""
    lblNo.Caption = "Printer_ID"
    lblName.Caption = "PrinterName 1"
...
On Error GoTo errHdl
    ...
    With res
        For i = 1 To UBound(arrUpdate)
            DoEvents
            .MoveFirst
            .Find "PrtID=" & arrUpdate(i)(0)
            'For j = 2 To .Fields.Count - 1
            DoEvents
                .Fields(2) = arrUpdate(i)(1)
            'Next j
            .Update
        Next i
    End With
