...
Begin VB.Form frmShowCust_Stock_Report 
   Caption         =   " "
   ClientHeight    =   9120
   ClientLeft      =   60
   ClientTop       =   345
   ...
   EndProperty
   Icon            =   "frmShowCust_Stock_Report.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9120
   ScaleWidth      =   13725
   ...
   Begin VB.PictureBox picToolsBar 
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   480
         Left            =   8940
         Picture         =   "frmShowCust_Stock_Report.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   180
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   480
         Left            =   8520
         Picture         =   "frmShowCust_Stock_Report.frx":034E
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   180
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   480
         Left            =   7200
         Picture         =   "frmShowCust_Stock_Report.frx":0690
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   180
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   480
         Left            =   6780
         Picture         =   "frmShowCust_Stock_Report.frx":09D2
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   180
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrint 
         Height          =   510
         Left            =   9420
         Picture         =   "frmShowCust_Stock_Report.frx":0D14
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   195
         Width           =   885
      ...
      Begin prjTouchScreen.MyButton cmdExport 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmShowCust_Stock_Report.frx":13FE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdClose 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmShowCust_Stock_Report.frx":141A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmShowCust_Stock_Report"
...
'    End If
    Select Case opt
        ...
        Case 2
            SQL = "SELECT Inventory_In_Master.Stock_ID,Inventory_In" & Table_Month & ".ItemNum, Inventory_In" & Table_Month & ".Description, Sum(Inventory_In" & Table_Month & ".Quantity) AS Qty, Avg(Inventory_In" & Table_Month & ".CostPer) AS Cost, Sum(Inventory_In" & Table_Month & ".Amount) AS Amt" & _
                 " FROM Inventory_In_Master INNER JOIN Inventory_In" & Table_Month & " ON Inventory_In_Master.Doc_Number = Inventory_In" & Table_Month & ".Doc_Number" & _
                 " WHERE (((Inventory_In_Master.DateTime)>='" & from_Date & "' And (Inventory_In_Master.DateTime)<='" & To_Date & "') AND ((Inventory_In_Master.InOutType)='I')) and Inventory_In_Master.Vendor_Number='" & txtVendor_Num.Text & "'" & _
                 " GROUP BY Inventory_In_Master.Stock_ID,Inventory_In" & Table_Month & ".ItemNum, Inventory_In" & Table_Month & ".Description"
    End Select
