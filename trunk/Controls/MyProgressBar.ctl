...
Begin VB.UserControl MyProgressBar 
   ...
   Begin VB.Image blue 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":0312
      Top             =   2280
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image blue 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":0444
      Top             =   2280
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image blue 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":07C7
      Top             =   2280
      Visible         =   0   'False
      Width           =   120
   End
   ...
   Begin VB.Image goldmet 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":0B4B
      Top             =   2040
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image goldmet 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":0C7D
      Top             =   2040
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image goldmet 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":0DAF
      Top             =   2040
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image bluemet 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":0EE1
      Top             =   1800
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image bluemet 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":1013
      Top             =   1800
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image bluemet 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":1145
      Top             =   1800
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image orangemet 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":1277
      Top             =   1560
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image orangemet 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":15F2
      Top             =   1560
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image orangemet 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":1976
      Top             =   1560
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image greymet 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":1CF3
      Top             =   1320
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image greymet 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":2066
      Top             =   1320
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image greymet 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":23E9
      Top             =   1320
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image redmet 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":275E
      Top             =   1080
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image redmet 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":2890
      Top             =   1080
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image redmet 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":2C14
      Top             =   1080
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image grmet 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":2F98
      Top             =   840
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image grmet 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":30CA
      Top             =   840
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image grmet 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":344E
      Top             =   840
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image master 
      ...
      Index           =   1
      Left            =   600
      Picture         =   "MyProgressBar.ctx":37D2
      Top             =   600
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image master 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "MyProgressBar.ctx":3B51
      Top             =   600
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image blank 
      Height          =   150
      Left            =   120
      Picture         =   "MyProgressBar.ctx":3ED5
      Top             =   360
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image master 
      ...
      Index           =   2
      Left            =   840
      Picture         =   "MyProgressBar.ctx":4007
      Top             =   600
      Visible         =   0   'False
      Width           =   120
   End
   Begin VB.Image img 
      Height          =   195
      Left            =   120
      Picture         =   "MyProgressBar.ctx":4139
      Top             =   120
      Visible         =   0   'False
      Width           =   885
   End
...
Dim wu, hu, W, H, P, i, a As Integer
Dim bx As Long
...
Again:
    If i < (bx * per) Then  ' procent of data must be equal all the time with progress
        If i + 10 >= wu Then
            CheckEnd
        End If
        If chend = 0 Then
