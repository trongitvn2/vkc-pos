...
Begin VB.Form frmGeneralData 
   ...
   Begin VB.Frame frmCmd 
      ...
      Begin prjTouchScreen.MyButton cmdClose 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmGeneralData.frx":0000
         PICN            =   "frmGeneralData.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdHelp 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmGeneralData.frx":62B6
         PICN            =   "frmGeneralData.frx":62D2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmGeneralData.frx":690C
         PICN            =   "frmGeneralData.frx":6928
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin TabDlg.SSTab tab1 
      ...
      EndProperty
      TabCaption(0)   =   "Set up"
      TabPicture(0)   =   "frmGeneralData.frx":6E6C
...
On Error GoTo errHdl
    ...
    DescArr = LoadLanguage(LngFile, "#03:030:")
...
'        .WindowState = 0
'    End With
    Set res = Open_Table(cnData, "CookingInstruction")
...
'    Call SetColorFlexGrid(flex, 1, 1, 2)
    With flex
        ...
        .ScrollTrack = True
    End With
    txtData.MaxLength = res.Fields("Data").DefinedSize
    flex_Click
    ...
    With res
        If .RecordCount > 0 Then
            ...
            Do While Not .EOF
                ...
                flex.TextMatrix(irow, 0) = !NO
                flex.TextMatrix(irow, 1) = !Data
                irow = irow + 1
                .MoveNext
            Loop
        End If
...
On Error GoTo errHdl
    ...
    With flex
        ...
        .ColWidth(1) = 5500: .ColAlignment(1) = 1
    End With
