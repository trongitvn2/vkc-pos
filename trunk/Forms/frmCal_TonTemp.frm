...
Begin VB.Form frmCal_TonTemp 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label lblProcess 
         Alignment       =   2  'Center
         BackColor       =   &H80000012&
         Caption         =   "§ang xö lý....Vui lßng ®îi trong gi©y l¸t !"
         BeginProperty Font 
            Name            =   ".VnArialH"
            Size            =   12.75
            Charset         =   0
...
Private Sub cmdCal_Click()
    lblProcess.Caption = "§ang xö lý....Vui lßng ®îi trong gi©y l¸t !"
    ...
    lblProcess.Caption = "§· hoµn tÊt tÝnh tån kho"
End Sub
