...
Begin VB.Form frmReceipt 
   ...
   Caption         =   "Danh môc c¸c kho¶n thu"
   ClientHeight    =   7050
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9870
   ...
   Begin VB.Frame frmCmd 
      ...
      Begin prjTouchScreen.MyButton cmdThem 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmReceipt.frx":000C
         PICN            =   "frmReceipt.frx":0028
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdCapnhat 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmReceipt.frx":047A
         PICN            =   "frmReceipt.frx":0496
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdXoa 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmReceipt.frx":09DA
         PICN            =   "frmReceipt.frx":09F6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdHelp 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmReceipt.frx":1030
         PICN            =   "frmReceipt.frx":104C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjTouchScreen.MyButton cmdClose 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmReceipt.frx":1686
         PICN            =   "frmReceipt.frx":16A2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin TabDlg.SSTab tabGroup 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TabCaption(0)   =   "Kho¶n thu"
      TabPicture(0)   =   "frmReceipt.frx":793C
...
Private Sub UpdateDatabase()
    On Error GoTo Handle
        With rsKhoanchi
            .Find "MaThu='" & txtMaChi.Text & _
                "'", , adSearchForward, adBookmarkFirst
            If .EOF Then
                .addNew
                .Fields("MaThu") = txtMaChi.Text
                .Fields("DienGiai") = txtDiengiai.Text
                .Update
                .Requery
            Else
                MsgBox "MaThu ®· tån t¹i, vui lßng kiÓm tra l¹i hoÆc ®æi m· kh¸c!", vbOKOnly
                Call DeleteTextbox
...
Private Sub cmdXoa_Click()
    ...
    Dim ans As Integer
    Dim ID As String
    ID = flgKhoanChi.TextMatrix(flgKhoanChi.Row, 0)
    If UCase(ID) <> "§C" And UCase(ID) <> "CN" Then
        ans = MsgBox("B¹n cã ch¾c ch¨n muèn xãa danh môc nµy kh«ng?", vbYesNo)
        If ans = vbYes Then
            With rsKhoanchi
                .Find "MaThu='" & ID & "'", , adSearchForward, adBookmarkFirst
...
Private Sub flgKhoanChi_EnterCell()
    On Error GoTo Handle
    With rsKhoanchi
        .Find "MaThu='" & flgKhoanChi.TextMatrix(flgKhoanChi.Row, 0) & _
                "'", , adSearchForward, adBookmarkFirst
        If Not .EOF Then
            txtMaChi.Text = !MaThu
...
On Error GoTo errHdl
    ...
    With flgKhoanChi
        ...
        .ColWidth(0) = 2500
        .ColWidth(1) = 7500
        .TextMatrix(0, 0) = "M· thu" 'DescArr(14)
        .TextMatrix(0, 1) = "DiÔn gi¶i thu" 'DescArr(15)
    End With
   ...
   flgKhoanChi.Rows = rsKhoanchi.RecordCount + 1
    ...
    Do While Not rsKhoanchi.EOF
        intCount = intCount + 1
        flgKhoanChi.TextMatrix(intCount, 0) = rsKhoanchi!MaThu
...
Private Sub LoadControl()
    ...
    With rsKhoanchi
        .Find "MaThu='" & !MaThu & "'", , adSearchForward, adBookmarkFirst
        If Not .EOF Then
            txtMaChi.Text = !MaThu
            txtDiengiai.Text = !DienGiai
            .Requery
