VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} crBalance 
   ClientHeight    =   9510
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   15630
   OleObjectBlob   =   "crBalance.dsx":0000
End
Attribute VB_Name = "crBalance"
...
On Error GoTo Handle
    If Trim(txtCustomerID.Value) = "101" Then
