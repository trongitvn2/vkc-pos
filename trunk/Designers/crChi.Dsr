VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} crChi 
   ClientHeight    =   9300
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10740
   OleObjectBlob   =   "crChi.dsx":0000
End
Attribute VB_Name = "crChi"
...
Private Sub Section1_Format(ByVal pFormattingInfo As Object)
    lblDate.SetText gfCONVERT_STRING_TO_DATE(txtDate.Value)
End Sub
...
On Error GoTo Handle
    If rscompany.RecordCount > 0 Then
        ...
        lblInfor3.SetText "Ñòa chæ :" & rscompany.Fields("Company_info_3")
