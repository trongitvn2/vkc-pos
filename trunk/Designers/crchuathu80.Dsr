VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} crBanchuathu80 
   ClientHeight    =   9510
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   15315
   OleObjectBlob   =   "crchuathu80.dsx":0000
End
Attribute VB_Name = "crBanchuathu80"
...
Dim rscompany As New ADODB.Recordset
    ...
    If rscompany.RecordCount > 0 Then
        ...
        lblInfor4.SetText "Tel:" & rscompany.Fields("Company_info_4") & Space(2) & "Fax:" & rscompany.Fields("Company_info_5")
