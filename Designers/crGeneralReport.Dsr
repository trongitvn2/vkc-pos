...
If txtDelNotAmt.Value = 0 Then Section11.Suppress = True
End Sub
...
txtReadTotal.SetText readnumber(CDbl("0" & Abs(txtCashInDrawer.Value))) & " ®ång./."
End Sub
...
On Error GoTo Handle
If AdjAmt6.Value = 0 Then Section33.Suppress = True
    With rsAdjustment
