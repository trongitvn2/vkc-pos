VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} crSend_KP_Detail 
   ClientHeight    =   9480
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9585
   OleObjectBlob   =   "crSend_KP_Detail.dsx":0000
End
Attribute VB_Name = "crSend_KP_Detail"
...
Private Sub Section9_Format(ByVal pFormattingInfo As Object)
    If txtTotalAmt.Value < 0 Then
            txtReadTotal.SetText "©m " & readnumber(CDbl("0" & Abs(txtTotalAmt.Value))) & " ®ång"
        Else
