VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} crGeneral58 
   ClientHeight    =   9510
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   16425
   OleObjectBlob   =   "crGeneral58.dsx":0000
End
Attribute VB_Name = "crGeneral58"
...
If txtAmountROA.Value = 0 Then Section26.Suppress = True
End Sub
...
On Error GoTo Handle
If AdjAmt3.Value = 0 Then Section29.Suppress = True
    With rsAdjustment
...
On Error GoTo Handle
If AdjAmt4.Value = 0 Then Section30.Suppress = True
    With rsAdjustment
...
On Error GoTo Handle
If AdjAmt5.Value = 0 Then Section31.Suppress = True
    With rsAdjustment
...
On Error GoTo Handle
If AdjAmt6.Value = 0 Then Section32.Suppress = True
    With rsAdjustment
...
On Error GoTo Handle
    ...
    If rscompany.RecordCount > 0 Then
        ...
        lblInfor4.SetText rscompany.Fields("Company_info_4") & Space(10) & "Fax:" & rscompany.Fields("Company_info_5")
